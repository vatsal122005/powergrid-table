        ...
        <form wire:submit.prevent="save" class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" id="sku" wire:model.live.debounce.300ms="sku"
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="number" id="price" wire:model.blur="price" step="0.01" min="0"
                ...
                <div>
                    ...
                    <input type="number" id="stock_quantity" wire:model.blur="stock_quantity" min="0"
